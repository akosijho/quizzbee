...
import 'package:game_challenger/views/new_challenge/components/option_builder.dart';
...
class NewChallenge extends StatelessWidget {
  const NewChallenge({required this.challenge, required this.player, super.key});
