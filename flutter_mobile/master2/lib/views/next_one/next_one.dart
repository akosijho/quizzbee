...
import 'package:master2/views/next_one/components/choice_builder.dart';
import 'package:stacked/stacked.dart';

import '../../core/models/challenge.dart';
import '../../widgets/build_body.dart';
import 'next_one_view_model.dart';

class NextOne extends StatelessWidget {
  const NextOne({required this.q, Key? key}) : super(key: key);
